...
export default function MainLayout(){
  ...
  return <div className="fund-app"><a className="skip-link" href="#main-content">跳到主要内容</a>{open&&<button className="sidebar-backdrop" aria-label="关闭导航" onClick={()=>{setOpen(false);menuButton.current?.focus();}}/>}
    <aside className={'sidebar '+(open?'is-open':'')} aria-label="基金工作区导航"><Link className="brand" to="/"><img className="brand-logo" src={`${import.meta.env.BASE_URL}brand-strawberry.png`} alt="快刀切草莓君" width={40} height={40} />compound</Link>
